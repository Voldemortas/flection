...
const RINKTA = makeDeclinedFromArray(
  `rinktà  rinktõs  riñktai  riñktą  rinktà  rinktojè rinkto\u0303j  rinktà 
...
const NESIRINKTA = makeDeclinedFromArray(
  `nesirinktà  nesirinktõs  nesìrinktai  nesìrinktą  nesìrinkta  nesirinktojè nesirinkto\u0303j  nesirinktà 
...
const BEGTA = makeDeclinedFromArray(
  `bėgtà  bėgtõs  bė́gtai  bė́gtą  bė́gta  bėgtojè bėgto\u0303j  bėgtà 
...
const NEKURTA = makeDeclinedFromArray(
  `nekurtà  nekurtõs  nekùrtai  nekùrtą  nekùrta  nekurtojè nekurto\u0303j  nekurtà 
...
const NEBRISTA = makeDeclinedFromArray(
  `nebristà  nebristõs  nèbristai  nèbristą  nèbrista  nebristojè nebristõj  nebristà 
